...
function getReceipt() {
	...
	// logic- for and if statements
	for (var i = 0; i < sizeArray.length; i++) { //parameters
	...
	if (selectedSize === "Personal Pizza") {
		...
		// will add the monetary value of the sizeTotal to the runningTotal. 
		getMeat(runningTotal,text1,text2);
		// will call next function and pass along our variables.
};			
//meat and veges are same format
//meat
...
// cheease and crust are same format
//cheese
